...
### training phase: perceptron iteration loop
def dev_test(w):
	err = 0
...
# list(map(lambda tup: print(foi[tup[0]]), w_smart_avg_sorted[:-6:-1]))
# not using list comprehension or map for their side-effects due to inefficiency concerns
